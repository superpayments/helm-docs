...
func getHelmDocsVersionTemplates() string {
	...
	versionSectionBuilder.WriteString("Autogenerated from chart metadata using [helm-docs v{{ .HelmDocsVersion }}](https://github.com/k8s-at-home/helm-docs/releases/v{{ .HelmDocsVersion }})")
